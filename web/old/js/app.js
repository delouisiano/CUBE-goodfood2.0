...
document.getElementById("inscription").addEventListener("submit", function(e) {
	...
	if (localStorage.getItem("pseudo") == "" || localStorage.getItem("mail") == "" || localStorage.getItem("mail2") == "" || localStorage.getItem("mdp") == ""  || localStorage.getItem("mdp2") == "" ) {
	...
	if (err == "") {
		...
		//EVOIE DES DONNÉES
		xhr.send("pseudo="+localStorage.getItem("pseudo")+"&mdp="+localStorage.getItem("mdp")+"&mdp2="+localStorage.getItem("mdp2")+"&mail="+localStorage.getItem("mail")+"&mail2="+localStorage.getItem("mail2"));
	}
	else{
