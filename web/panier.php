		    ...
		    <div class="row">
		        ...
		        <div class="row">
		            ...
		            <div class="col-sm-12 col-md-1 text-right">
		                <button onclick="location.href='http:/adresseCommande.php';" class="btn btn-lg btn-block btn-success text-uppercase">Suivant</button>
		            </div>
		        </div>
...
?>
    ...
    <tr>
        ...
        <td class="text-right"><button class="btn btn-sm btn-danger" onclick="supprArticlePanier(<?php  echo $id  ?>);redirection('/panier.php');" value="<?php echo $id ?>">❌</button> </td>
    </tr>
